function startIntro() {
  ...
  intro.setOptions({
    ...
    steps: [
      {
        intro:
          'Welcome to CourseSelection! We\'ll take you on a brief tour to show you how to use the app. Click "Next" to begin.',
      },
      {
        element: '#search-pane',
      ...
      },
      {
        element: '#netid-btn',
        intro:
          "Click here to change your major and year in the settings.<br><br>If you've missed anything, you can also view the tutorial here at any time.<br><br>We hope you enjoy using CourseSelection!",
      },
    ],
  });
  intro.start();
