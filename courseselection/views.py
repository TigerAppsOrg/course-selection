...
def index(request):
    ...
    if request.user.is_authenticated:
        ...
        return render(request, 'courseselection/index.html', context)
    else:
        return landing(request)

# landing page
def landing(request):
    return render(request, 'courseselection/landing.html', None)

# about page
def about(request):
    return render(request, 'courseselection/about.html', None)

# privacy policy page
def privacy_policy(request):
    return render(request, 'courseselection/privacy.html', None)
