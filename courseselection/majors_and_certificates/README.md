...
files are listed in [`scripts/university_info.py`](https://github.com/CourseSelectionApp/courseselection/blob/master/courseselection/majors_and_certificates/scripts/university_info.py).
...
# any requirement that CourseSelection cannot possibly verify,
